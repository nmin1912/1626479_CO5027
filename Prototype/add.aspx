<%@ Page Title="" Language="C#" MasterPageFile="~/Master Page.Master" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="Prototype.add" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form id="form1" runat="server" style="height: 176px">
        <div id="adminNav">
          <ul >
        ...
        <h2>ADD PRODUCTS</h2>
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="ProductID" DataSourceID="SqlDataSource" DefaultMode="Insert" style="font-style: italic" Height="197px" OnPageIndexChanging="FormView1_PageIndexChanging" Width="520px">
            <EditItemTemplate>
                ProductID:
            ...
            <InsertItemTemplate>
                ...
                <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">Insert Image</asp:LinkButton>
